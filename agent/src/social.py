...
INTENTS = ("none", "follow_owner", "stop", "look_at_owner", "pickup_item")
INTENT_INSTRUCTIONS = (
    ...
    "拾って・落ちてるもの拾って→pickup_item。"
    "拾得は最も近い落下物だけが対象で、種類を選べません。特定の品物を指定した依頼はnoneにして、"
    "近くの落ちているものなら拾えると説明してください。"
